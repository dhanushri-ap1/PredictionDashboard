            ...
            <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
              ...
              <button style={{
                ...
                <svg width="12" height="12" viewBox="0 0 12 12" fill="none">
                  <path d="M6 1V3M6 9V11M1 6H3M9 6H11M2.64 2.64L4.05 4.05M7.95 7.95L9.36 9.36M2.64 9.36L4.05 7.95M7.95 4.05L9.36 2.64" stroke="white" strokeWidth="1.2" strokeLinecap="round"/>
                </svg>
                Export Report
              </button>
            </div>
        ...
        {missions.map(m => (
          ...
          >
            ...
            <div style={{ flex: 1 }}>
              ...
              <div style={{ fontSize: 10, color: 'var(--gray-400)', fontFamily: 'var(--font-mono)' }}>{m.type} • {m.volunteers} volunteers</div>
            </div>
            <span style={{
              padding: '2px 8px',
